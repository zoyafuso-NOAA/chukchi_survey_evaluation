...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
set.seed(234)
for (temp_res in c(65000, 46000, 37000, 32500)) {
...
##   Performance Metrics ----
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
true_cv_sys <- sweep(x = apply(X = index_sys, MARGIN = 1:2, FUN = sd, na.rm = T), 
                     MARGIN = 2, 
...
rrmse_cv_sys <- sqrt(apply(X = sweep(x = cv_sys,
                                     ...
                                     FUN = "-") ^ 2, ## Square Error
                           MARGIN = 1:2,
                           FUN = mean, na.rm = T) ## Mean Square Error
) /## Root Mean Square Error, Normalize by mean(cvs)
  apply(X = cv_sys, MARGIN = 1:2, FUN = mean, na.rm = T) 
...
save(list = c("index_sys", "cv_sys", "rb_index_sys", "true_cv_sys", 
     ...
     file = paste0("presentations/2022/WKUSER_2022/results/Str_3/sys_survey_sim_results.RData"))
