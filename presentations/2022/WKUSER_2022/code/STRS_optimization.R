...
##               For the WKUSER2 conference: simplified analysis
##               Otter trawl only, using the original 6 species we looked at:
##               Arctic cod, snow crab, Bering flounder, saffron cod, Alaska 
##               plaice, yellowfin sole. 
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
rm(list = ls())
...
curr_dir <- paste0(getwd(), "/presentations/2022/WKUSER_2022/")

##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##  Assign Gear ----
##  Define species list and only include 2012
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
igear = "otter"
...
ms_dens <- array(dim = c(n_spp, n_cells), 
...
Y <- t(ms_dens)
colnames(Y) <- paste0("Y", 1:n_spp)
Y_SQ_SUM <- Y^2
colnames(Y_SQ_SUM) <- sapply(X = 1:n_spp, 
                             FUN = function(x) paste0("Y", x, c("_SQ_SUM")))
frame_df <- cbind(frame_df_otter[, c("domainvalue", "id", "X1", "X2")],
                  WEIGHT = 1,
                  Y, Y_SQ_SUM)

total_n <- seq(from = 50, to = 200, by = 50)
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
result_dir <- paste0(curr_dir, "/results/Str_3/")
