###############################################################################
## Project:       Process Chukchi and NBS otter and beam  trawl data for A-IERP
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
output_dir <- "data/fish_data/AK_BTS_OtterAndBeam/"
...
for (irow in 1:nrow(solo_spp)) {
  ...
  if (ispp_code %in% names(data_wide)) {
    dat_wide <- data_wide[, c("YEAR", "MONTH", "DAY", "DATE", "GEAR_CAT", 
                               "MEAN_LONGITUDE", "MEAN_LATITUDE", "HAULJOIN", 
                               "GEAR_DEPTH", "GEAR_TEMPERATURE", 
                               "AREA_SWEPT", ispp_code)]
    names(dat_wide)[ncol(dat_wide)] <- "catch_kg"
    
    dat_wide <- dat_wide %>% select(year = 'YEAR', 
                                     month = 'MONTH', 
                                     day = 'DAY', 
                                     date = 'DATE', 
                                     gear = 'GEAR_CAT', 
                                     ...
                                     lat = 'MEAN_LATITUDE', 
                                     hauljoin = 'HAULJOIN',
                                     bot_depth_m = 'GEAR_DEPTH', 
                                     bot_temp_c = 'GEAR_TEMPERATURE', 
                                     area_swept_km2 = 'AREA_SWEPT') %>% 
                          mutate(common_name = ispp)
  }
}

##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# STOPPED THE ADAPTATION HERE to pivot to a different approach
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
