...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
{
  ...
  png(filename = paste0("figures/FigureX_ms_strs_sols.png"),
      units = "mm", width = 85, height = 165, res = 500)
  ...
  for (igear in c("otter", "beam")) { ## Loop over gears -- start
    for (istrata in 3:5) { ## Loop over strata -- start
